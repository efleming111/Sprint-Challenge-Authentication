...
1. What is the purpose of using _sessions_?
    ...
    Sessins are used to persist data across calls to the database.

1. What does bcrypt do to help us store passwords in a secure manner.

    It hashs passwords so that the database isn't storing plain text passwords.

1. What does bcrypt do to slow down attackers?

    It salts the hash by hashing the password multiple times.
